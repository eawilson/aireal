...
CREATE TABLE bsexcludedlane (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY, 
    bsappsession_bsid VARCHAR NOT NULL, --not a foreign key as created before appsession imported
    lane INTEGER NOT NULL,
    datetime_created TIMESTAMP WITH TIME ZONE NOT NULL,
    users_id INTEGER NOT NULL,
    CONSTRAINT pk_bsexcludedlane PRIMARY KEY (id),
    CONSTRAINT uq_bsexcludedlane_bsappsession_bsid_lane UNIQUE (bsappsession_bsid, lane),
...
--     id INTEGER GENERATED BY DEFAULT AS IDENTITY,
--     bsappsession_bsid INTEGER NOT NULL,
--     name VARCHAR NOT NULL,
--     datetime_created TIMESTAMP WITH TIME ZONE NOT NULL,
--     users_id INTEGER NOT NULL,
...
CREATE TABLE bsstatus (
    ...
    CONSTRAINT uq_bsstatus_status UNIQUE (status)
    );
...
CREATE TABLE bsimportedsample (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY,
    bsappsession_bsid VARCHAR NOT NULL,
    name VARCHAR NOT NULL,
    users_id INTEGER NOT NULL,
...
--DROP TABLE bsimportedsample, bsstatus, bsexcludedlane, bsdataset, bsappsession, bsaccount_bsrun, bsrun, bsaccount_users, bsaccount, bsserver;
